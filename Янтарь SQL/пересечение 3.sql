/*Пересечение процедур*/ 
	...
	,	CASE
		...
		END
	,	CASE
			WHEN o.attr_4027_ && o.attr_4443_ AND
				(o.attr_4027_ && ARRAY[1] OR o.attr_4443_ && ARRAY[1]) <> TRUE
				THEN concat('Грязетерапия||Ингаляция', '\n')
		END
	,	CASE
			WHEN o.attr_4027_ && o.attr_4446_ AND
				(o.attr_4027_ && ARRAY[1] OR o.attr_4446_ && ARRAY[1]) <> TRUE
