select o1.fio, o1.proc, o1.nom, o1.hist_id, o1.time_proc, o1.date_rasp
from (
select fio_pac.attr_1985_ as fio, proc_id.attr_695_ as proc, nom_cat.attr_444_ as nom, o.attr_4005_ as hist_id, o.attr_4032_ as date_rasp,
...
case when o.attr_4007_@>array[3] then concat('08:30 - 08:50', '\n') end,
...
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4007_ is not null  and  o.attr_4005_ = '{superId}'
...
case when o.attr_4009_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4009_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4011_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4011_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4013_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4013_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4015_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4015_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4017_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4017_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4019_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4019_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4021_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4021_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4023_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4023_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4025_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4025_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4027_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4027_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4029_@>array[3] then concat('08:30 - 08:50', '\n')  end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4029_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4162_@>array[3] then concat('08:30 - 08:50', '\n') end,
...
where o.is_deleted<>true and  o.attr_4162_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4165_@>array[3] then concat('08:30 - 08:50', '\n') end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true  and o.attr_4165_ is not null and  o.attr_4005_ = '{superId}'
...
case when o.attr_4168_ @>array[3] then concat('08:30 - 08:50', '\n') end,
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4168_ is not null and  o.attr_4005_ = '{superId}'
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4251_ is not null and  o.attr_4005_ = '{superId}'
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4443_ is not null and  o.attr_4005_ = '{superId}'
...
left join registry.object_45_ fio_pac on o.attr_4004_=fio_pac.id and fio_pac.is_deleted<>true
left join registry.object_127_ nom_cat on o.attr_4006_=nom_cat.id and nom_cat.is_deleted<>true
where o.is_deleted<>true and o.attr_4446_ is not null and  o.attr_4005_ = '{superId}'
