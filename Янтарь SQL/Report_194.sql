 WITH base AS (
	...
	FROM
      ...
      SELECT
	base."fio", base."nom", 
	MAX(CASE WHEN base."attr_proc" = 'lfk1' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "lfk1", 
	MAX(CASE WHEN base."attr_proc" = 'lfk2' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "lfk2", 
	MAX(CASE WHEN base."attr_proc" = 'bass' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "bass", 
	MAX(CASE WHEN base."attr_proc" = 'hidro' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "hidro", 
	MAX(CASE WHEN base."attr_proc" = 'ergo' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "ergo", 
	MAX(CASE WHEN base."attr_proc" = 'logo' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "logo", 
	MAX(CASE WHEN base."attr_proc" = 'pshich' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "pshich", 
	MAX(CASE WHEN base."attr_proc" = 'irt' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "irt", 
	MAX(CASE WHEN base."attr_proc" = 'mass' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "mass", 
	MAX(CASE WHEN base."attr_proc" = 'ft' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "ft", 
	MAX(CASE WHEN base."attr_proc" = 'gt' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "gt", 
	MAX(CASE WHEN base."attr_proc" = 'sol_p' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "sol_p", 
	MAX(CASE WHEN base."attr_proc" = 'girudo' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "girudo", 
	MAX(CASE WHEN base."attr_proc" = 'fito' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "fito", 
	MAX(CASE WHEN base."attr_proc" = 'kisl_coct' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "kisl_coct", 
	MAX(CASE WHEN base."attr_proc" = 'soc_cult' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "soc_cult", 
	MAX(CASE WHEN base."attr_proc" = 'inhal' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "inhal", 
	MAX(CASE WHEN base."attr_proc" = 'presso' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "presso", 
	MAX(CASE WHEN base."attr_proc" = 'dry_needle' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "dry_needle", 
	MAX(CASE WHEN base."attr_proc" = 'vtes' THEN CONCAT(base."time_proc", CASE WHEN {incl_comm} AND base."comment" is not null THEN '\n'||base."comment" END) END) AS "vtes"
FROM
	base 
WHERE
