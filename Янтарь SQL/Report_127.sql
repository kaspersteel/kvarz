     WITH o AS (
          ...
          LEFT JOIN registry.object_45_ fio_pac ON base.attr_4004_ = fio_pac.id
                AND fio_pac.is_deleted <> TRUE
          LEFT JOIN registry.object_127_ nom_cat ON base.attr_4006_ = nom_cat.id
                AND nom_cat.is_deleted <> TRUE
              WHERE base.is_deleted <> TRUE
                AND base.attr_4032_ = '{date_rasp}'
          )
   SELECT              o1.fio
        , o1.proc
        , o1.nom
     ...
     FROM (
          ...
          LEFT JOIN registry.object_694_ proc_id ON pl.attr_784_ = proc_id.id
                AND proc_id.is_deleted <> TRUE
              WHERE o.attr_4446_ IS NOT NULL
          UNION ALL
             SELECT o.attr_1985_      AS fio
                  , proc_id.attr_695_ AS proc
                  , o.attr_444_       AS nom
          ...
          LEFT JOIN registry.object_694_ proc_id ON pl.attr_784_ = proc_id.id
                AND proc_id.is_deleted <> TRUE
              WHERE o.attr_4455_ IS NOT NULL
          UNION ALL
             SELECT o.attr_1985_      AS fio
                  , proc_id.attr_695_ AS proc
                  , o.attr_444_       AS nom
          ...
          LEFT JOIN registry.object_694_ proc_id ON pl.attr_784_ = proc_id.id
                AND proc_id.is_deleted <> TRUE
              WHERE o.attr_4458_ IS NOT NULL
          ) o1
