select o1.fio, o1.proc, o1.nom, o1.hist_id, o1.time_proc, o1.date_rasp, coalesce((CASE WHEN '{date_rasp}' ='' THEN null else '{date_rasp}'::text END),CURRENT_DATE::text)::date as data
from (
...
where o.is_deleted<>true and  o.attr_4005_ = '{superid}'
...
and o1.date_rasp=coalesce((CASE WHEN '{date_rasp}' ='' THEN null else '{date_rasp}'::text END),CURRENT_DATE::text)::date
