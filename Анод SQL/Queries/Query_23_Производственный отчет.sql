  ...
  , pos_data AS (
        SELECT
          ...
          , SUM(t_op.attr_1443_ * comp.attr_1896_) FILTER (
                WHERE
                    to_accept.attr_3208_ = t_op.attr_613_
        ...
        FROM
            ...
            LEFT JOIN registry.object_2137_ accept_list ON accept_list.attr_2632_ = nom_in_comp.ID
            AND (
                comp_task.ID = ANY (accept_list.attr_3904_)
                OR comp_task.attr_2173_ = accept_list.attr_2226_
            )
