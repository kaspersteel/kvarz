     WITH DATA AS (
             SELECT o.ID AS project_id
                  ...
                  , /*давальческий*/ comp.attr_3934_ AS given_mat
                  , /*если тип - МвС, взять данные из него*/ comp.attr_1548_::DATE AS date_cut
                  , /*материал из техкарты или компонента состава ном. ед.*/ CASE
                              WHEN comp.attr_1452_ = 16 THEN comp_structure.attr_3967_
                              ELSE tech_card.attr_2381_
                    END AS mat
                  , /*сортамент*/ tech_card.attr_1876_ AS sort
                  , /*типоразмер*/ tech_card.attr_1877_ AS tr
                  , /*количество материала различного типа*/ CASE
   ...
   SELECT STRING_AGG(DISTINCT DATA.comp_id::TEXT, ', ') AS comp_ids
