   SELECT o.id,
              ...
              WHERE o1.is_deleted IS FALSE
                ...
                AND o1.attr_3208_ = (
                       SELECT MIN(o2.attr_3208_)
                        ...
                        WHERE o2.is_deleted IS FALSE
                          AND o2.attr_2149_ = 40
                          AND o2.attr_2148_ = accepted_list.id
                    )
          ) AS otk_tokr,
          /*Фрезерная*/ (
             SELECT o1.attr_2609_
          ...
          /*Отрезная-Проверка*/ CASE
                    ...
                    (
                       SELECT ARRAY_AGG(DISTINCT o1.attr_2149_)
                        ...
                        WHERE o1.is_deleted IS FALSE
                          AND o1.attr_2148_ = accepted_list.id
                          AND o1.attr_2150_ = accepted_list.attr_2632_
                    )::TEXT[]
                    ) THEN (
                    CASE
                              WHEN (
          ...
          /*Слесарно-сборочная-Проверка*/ CASE
                    WHEN '55' = ANY (
                    (
                       SELECT ARRAY_AGG(DISTINCT o1.attr_2149_)
                         FROM registry.object_2138_ o1
          ...
          /*Отрезная_Проверка2 (Если кол-во больше, чем планове = синий)*/ CASE
                    WHEN (
                       SELECT o1.attr_2609_
                         FROM registry.object_2138_ o1
                        WHERE o1.is_deleted IS FALSE
          ...
          /*Слесарно-сборочная-Проверка2*/ CASE
                    WHEN (
                       SELECT o1.attr_2609_
                         FROM registry.object_2138_ o1
                        WHERE o1.is_deleted IS FALSE
          ...
          /*Комплектовочная-Проверка2*/ CASE
                    WHEN (
                       SELECT o1.attr_2609_
                         FROM registry.object_2138_ o1
                        WHERE o1.is_deleted IS FALSE
