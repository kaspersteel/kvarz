...
LEFT JOIN registry.object_2967_ sluj_reg ON sluj_reg.attr_2972_ = 296 /*:currentUser*/
    WHERE mat.is_deleted <> TRUE
      ...
      AND (
          mat.attr_1353_ = sluj_reg.attr_2971_
       OR up_level.attr_1353_ = sluj_reg.attr_2971_
          )
      AND sort.attr_1373_ = sluj_reg.attr_3161_
      AND (
          typer.attr_1384_ = sluj_reg.attr_3162_
       OR typer.attr_1385_ = sluj_reg.attr_3162_
          )
 ORDER BY mat.id
        , sort.id
        , typer.attr_401_